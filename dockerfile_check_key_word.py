...
def find_keyword_in_dockerfile(repo_paths, keyword):
    """
...
if __name__ == "__main__":
    # 使用者可修改以下路徑與關鍵字
    repo_paths = [
        "/Users/bing-wei/Documents/swissknife/PI/other/asurada",
        "/Users/bing-wei/Documents/swissknife/PI/other/inner-service",
        "/Users/bing-wei/Documents/swissknife/PI/other/translation-management-system"
    ]
    # 替換為你要搜尋的關鍵字
    keyword = "gcr.io/rd6-project"
    find_keyword_in_dockerfile(repo_paths, keyword)
